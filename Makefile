...
#    Updated: 2019/08/07 23:30:28 by aashara-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
.PHONY: all lclean lfclean fclean $(libft) $(libstr) $(libdir)\
		$(libdar) $(libstack) $(libfifo) create_dir
...
$(lib_dir): $(libft) $(libstr) $(libdir) $(libdar) $(libstack) $(libfifo)
	...
	@echo "\033[1;33m\033[1mFinish $(lib_dir)\033[0m\n"
